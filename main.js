...
class Kitablar {
    ...
    qiymet_iste(endirim) {
      return endirim=(this.qiymet*endirim)/100
    }
  }
  
  
  
  const myClass = new Kitablar("harry poter", "J. K. Rowling", '30 Haziran 1997 ', 30);
  // console.log(myClass.qiymet_iste(70));;

 console.log(myClass.ad,myClass.muellif,myClass.tarix,myClass.qiymet,
  '$','endirimli qiymeti',myClass.qiymet_iste(70),'$',);
...
//     return this.ad+this.muellif+this.tarix+this.qiymet+"$ "+'tetbiq edilen endirim '+endirim+"% "+'('+'endirimli qiymeti '+this.endirim+"$ "+')'
//   }
// }
